"""Guard: the REST /api/brain/switch route delegates to the ONE shared switch
implementation (app_control.apply_provider_switch) instead of carrying its own
parallel validation — the voice gate, brain tools, CLI, and UI must never
drift apart again (AP-4 class).
"""
