...
# 10000113 where a 2976 ms silence ended the turn because the 3000 ms patience
...
async def test_long_active_speech_arms_wider_silence_window_autonomously() -> None:
    ...
    Scenario (session 10000113 analogue):
    ...
    assert utterances == [], (
        ...
        "session 10000113 recurrence: the STT probe never armed the window and the "
