...
Discord and tell me exactly what's going on in the current ExampleHub channels"
drove an 8-step Computer-Use mission that opened Discord, navigated to the
ExampleHub server / #general channel, closed a Nitro popup, and emitted ``done``
-- with ZERO scroll actions. The generic single-frame verifier rubber-stamped
"The Discord window is open, showing the 'ExampleHub' server and the '# general'"
...
_DISCORD_READ_GOAL = (
    "open discord and tell me exactly what's going on in the examplehub channels"
)
...
def test_goal_needs_reading_detects_informational_goals() -> None:
    informational = [
        "öffne discord und sag mir was in den examplehub channels abgeht",
        "open discord and tell me what's going on in the channels",
        "lies mir die neuesten nachrichten vor",
        "was steht in meinem discord",
        "zeig mir die neuesten nachrichten auf dem examplehub server",
        "what's happening on the examplehub discord",
