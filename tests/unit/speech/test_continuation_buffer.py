...
text as ONE turn. See SUBAGENT_SPAWN_REVIEW + Screenshot mission_019f1015-*.
...
# slow to finalize must still coalesce (live bug 2026-06-18, session 10000107).#
# --------------------------------------------------------------------------- #
...
def test_speech_resume_rearms_deadline_so_slow_continuation_still_joins(
    ...
    """Live bug 2026-06-18 (session 10000107): "Kannst du bitte..." was buffered,
...
# Live wedge 2026-06-19, session 10000118: "…morgen ist ja Montag, oder?" was   #
