...
class TestVocabularyWords:
    ...
    def test_multiword_casing_with_umlaut(self) -> None:
        ...
        c = corrector_for(("Nico Lütke", []))  # i18n-allow: umlauted proper name under test
        assert c.correct("write to nico lütke") == "write to Nico Lütke"  # i18n-allow: umlauted proper name under test
