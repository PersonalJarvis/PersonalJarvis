...
the weather like in Exampleville?" came out as
``'Hallo, was ist der West-Like in Exampleville?'`` (confidence 0.654), and  # i18n-allow
"Is it currently winter in Exampleville?" became ``'Ist es gerade Winter in
Exampleville?'``. The text itself was corrupted at the STT layer, so the
