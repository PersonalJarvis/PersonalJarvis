#!/usr/bin/env python3
"""Deterministic privacy gate for the ship-public-release skill.

This script is the *deterministic core* of the public-release workflow. The
skill's SKILL.md orchestrates the human-facing parts (asking the version bump,
showing the review, committing, tagging, pushing); everything that decides
*what leaves the machine* lives here so it is reproducible and not subject to
LLM improvisation.
...
Reports are JSON so the SKILL.md can summarise them for the human review.
"""
