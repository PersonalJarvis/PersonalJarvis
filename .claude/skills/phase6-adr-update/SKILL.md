...
- **Conflict with the master plan:** the active maintainer plan is binding. On a conflict between the plan and a new ADR, quote the relevant plan section and justify why the ADR deviates from it.
