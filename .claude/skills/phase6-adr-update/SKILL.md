...
- **Conflict with the master plan:** the plan at `C:\Users\Administrator\.claude\plans\also-er-muss-auch-lexical-pond.md` is binding. On a conflict between the plan and a new ADR: quote the plan section and justify why the ADR deviates from it.
