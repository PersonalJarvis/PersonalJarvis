...
**(C) Personal filesystem / machine identifiers** — `<USER_HOME>\…`, personal OneDrive paths, the `C--Users-<name>-…` memory-dir slug, Windows SID (`S-1-5-21-…`), machine/account name, internal GCP/project ids.
