...
# ------------------------------------------------------------------- pins
$EXPECTED_REPO            = 'personal-jarvis/PersonalJarvis'
...
$EXPECTED_INTOTO_IDENTITY_REGEXP = '^https://github\.com/personal-jarvis/PersonalJarvis/\.github/workflows/sign-installer\.yml@refs/tags/v[0-9]+\.[0-9]+\.[0-9]+(-[A-Za-z0-9._-]+)?$'
