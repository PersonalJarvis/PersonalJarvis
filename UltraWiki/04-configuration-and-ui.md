...
| **Embedding model** | multilingual local model via Ollama (bge-m3 class; one-time download) | any configured embedding-capable provider key (e.g. Gemini Embedding, OpenAI, Voyage, Mistral) | **full re-embed** — deliberate, wizard-guarded (D-3) |
