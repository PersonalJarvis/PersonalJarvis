...
verbatim from spec section 4 of:
docs/superpowers/specs/2026-05-11-pre-thinking-ack-flash-brain-design.md
(persona-prompt section revised 2026-05-13).
...
PERSONA_PROMPT_DE = """Du bist JARVIS, der persönliche Assistent des Nutzers. Du bist gerade in
...
"Jarvis", Marken-Namen (Spotify, Discord, GitHub, Outlook,
...
PERSONA_PROMPT_EN = """You are JARVIS, the user's personal assistant. You are in your
...
"Jarvis", brand names (Spotify, Discord, GitHub,
