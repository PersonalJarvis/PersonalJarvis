...
# Filename-safe slug: e.g. "ExampleContact Müller" → "examplecontact_mueller"  # i18n-allow: example name demonstrating umlaut-folding logic
...
def person_slug(name: str) -> str:
    ...
    Examples:
        "ExampleContact Müller"  → "examplecontact_mueller"  # i18n-allow: example name demonstrating umlaut-folding logic
        "Dr. Paul O."   → "dr_paul_o"
