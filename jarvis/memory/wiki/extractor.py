...
- "subjects" names who/what the fact is about (e.g. ["person-name"],
  ...
  the named topic slug. Example: "I live in Exampleville" uses kind "place"
  and subjects ["<user-slug>", "exampleville"].
...
- For a first-person fact about a named place, person, organization, project,
  asset, vehicle, or recurring activity, include BOTH the exact user slug and
  the named topic slug. A residence in Exampleville uses kind "place" and
  subject "exampleville" alongside the exact user slug.
