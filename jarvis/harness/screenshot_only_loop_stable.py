# ===========================================================================
# FROZEN "STABLE" COMPUTER-USE ENGINE  --  pre-Wave-1 snapshot (20260627-200739).
#
# Byte-for-byte copy of screenshot_only_loop.py at the moment before the Wave-1
# verification work began. This is the KNOWN-GOOD fallback: select it with
# [computer_use].engine = "stable" (instant, voice/config-flippable) to revert
# Computer-Use to exactly this state if the new work misbehaves. DO NOT edit this
# file -- its whole value is being the frozen pre-Wave-1 reference.
# ===========================================================================
...
# what's in the ExampleHub channel" is NOT satisfied by opening the app -- the
...
def _goal_needs_reading(goal: str) -> bool:
    ...
    the ExampleHub channels" reported done on a bare-open window, having never
