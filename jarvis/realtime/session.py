...
_HYBRID_ROLE_DIRECTIVE = (
    ...
    "intention is not a result, and a result marked unverified is an attempt, "
    "not a confirmation — say what was tried and that you cannot confirm it. "
    "When a request names SEVERAL targets, report "
