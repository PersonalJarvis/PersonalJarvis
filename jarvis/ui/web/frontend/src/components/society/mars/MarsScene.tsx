...
export function MarsScene({ hostRef, mode, neutral, awake, selected, onSelect, onOrbit, onOpenStation, reset,
  gigiVisible = true, gigiFocus = 0, gigiRecall = 0, reducedMotion = false,
