...
Binding design: `docs/agent-society/world-art-direction.md` (layout, camera,
palette, building language) under `docs/agent-society/MASTERPLAN.md` §4.
...
| `PixelPass.tsx` | `RenderPixelatedPass` + `OutputPass` composer — the retro look and the GPU budget. |
