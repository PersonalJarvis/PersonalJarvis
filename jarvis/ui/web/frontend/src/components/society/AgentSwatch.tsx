...
import { AgentSymbol, SymbolThinkingAccents } from "./AgentSymbol";
  ...
  return (
    ...
    >
      {isJarvis ? (
        ...
        />
        {thinking && <svg aria-hidden viewBox="0 0 40 44" className="pointer-events-none absolute inset-0 h-full w-full"><SymbolThinkingAccents color="#ffcf45" /></svg>}
        </>
      ) : (
