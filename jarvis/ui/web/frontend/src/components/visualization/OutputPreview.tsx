 ...
 *    a document, code highlighted, a table as a table, a picture as a
 *    picture; anything the page cannot draw is one click from Files.
 *
...
import { CsvTable, SourceView, deliverableDisplayPath } from "@/components/outputs/ArtifactViewer";
 ...
 * (HTML) and a binary are named and left to Files, where the reader has the
 * sandbox and the openers for them.
 */
function FileSection({
  ...
  if (kind === "image") {
    ...
    body = <SourceView path={file.path} text={full.data.text} />;
  }
