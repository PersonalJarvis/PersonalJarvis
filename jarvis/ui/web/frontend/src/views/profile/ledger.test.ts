...
describe("displayAddress", () => {
  it("prefers the preferred_address over the name", () => {
    ...
    expect(displayAddress(meta, "Ruben Lütke")).toBe("Chef"); // i18n-allow: intentional German address fixture
  });

  it("falls back to the first name", () => {
    expect(displayAddress(EMPTY_META, "Ruben Lütke")).toBe("Ruben"); // i18n-allow: German umlaut name fixture
    expect(displayAddress(EMPTY_META, "  Ruben  ")).toBe("Ruben");
  });
