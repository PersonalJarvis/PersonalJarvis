...
def _seed_entries() -> list[dict[str, Any]]:
    ...
    raw = [
        ...
        ("github", "GitHub (Repo)", "https://github.com/personal-jarvis/PersonalJarvis"),
        ("github", "GitHub (Profile)", "https://github.com/personal-jarvis"),
        ...
        ("x", "Alex Herz", "https://x.com/aethroc"),
