...
def _load_raw() -> dict[str, Any]:
    ...
    try:
        ...
        # A missing preference file is the normal first-run/default state.
        return {}
...
def clamp_font_size(value: Any) -> int:
    ...
    try:
        ...
        # Invalid user input intentionally resolves to the documented default.
        return FONT_DEFAULT
...
def reset() -> None:
    ...
    try:
        ...
        # Reset is idempotent; an already-absent preference needs no warning.
        return
    except OSError as exc:
