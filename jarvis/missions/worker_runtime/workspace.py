...
def _agents_md(mission_id: str) -> str:
    ...
    return (
        ...
        f"  reasonable DEFAULT, state your assumption in one short line, and\n"
        f"  EXECUTE it immediately with the appropriate tools.\n"
        f"- A working artefact built under a sensible assumption ALWAYS beats\n"
        f"  asking. Deliver something concrete this turn.\n\n"
