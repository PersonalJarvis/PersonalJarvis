...
# Retired cards are absent from fresh installs. A locally configured client
# remains user-owned; only untouched placeholder copies are removed from the
# default catalog merge.
_RETIRED_BUILTIN_IDS = frozenset({"spotify", "linkedin"})
