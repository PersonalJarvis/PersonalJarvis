---
plugin_id: onedrive
keywords: onedrive, onedrive
---

Use `onedrive/*` tools for explicit operations on the connected OneDrive service.
Search, upload and share files in your Microsoft OneDrive.
