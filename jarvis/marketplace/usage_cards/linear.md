...
- When searching, filter by assignee, status, or label to narrow results first.
- Create and update issues directly (full autonomy); report issue ID and URL afterwards.
- Cycle (sprint) and roadmap tools are also available for planning queries.
