---
plugin_id: slack
keywords: slack, nachricht, message, nachrichten, messages, channel, kanal, kanäle, dm, direktnachricht, direct message, team, posten, post, senden, send, schreiben, write, suchen, search
---
