---
plugin_id: onenote
keywords: onenote, onenote
---

Use `onenote/*` tools for explicit operations on the connected OneNote service.
Read notebooks and pages; create and update notes.
