---
plugin_id: discord
keywords: discord, server, channel, kanäle, channels, kanal, nachricht, nachrichten, message, messages, dm, direktnachricht, guild, guilds, member, mitglied, senden, send, schreiben, write
---
