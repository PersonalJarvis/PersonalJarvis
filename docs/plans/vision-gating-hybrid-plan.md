...
_VISUAL_MARKERS: tuple[str, ...] = (
    ...
    "was steht da", "was steht hier", "was ist das hier", "lies vor",
...
Expected: PASS — "wie spät ist es" → `()`, "was siehst du hier" → 1 image ("siehst"), "schau mal das hier" → 1 image ("schau"). The inversion does not break these because the kept-image cases all carry markers.
