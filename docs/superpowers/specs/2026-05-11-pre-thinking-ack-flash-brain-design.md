...
| `"Erstelle mir einen Projekt-Atlas-Bericht für morgen"` | Topic-specific sentence requesting a report | Multi-step external task | Ack → spawn_worker → Final answer | <!-- i18n-allow: quoted German voice example -->
