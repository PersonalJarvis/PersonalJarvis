...
`PersonalJarvis/homebrew-jarvis` tap, `scoop install` via the
`PersonalJarvis/scoop-jarvis` bucket). Tag `v0.5.0-supplychain-wave4`.
...
`PersonalJarvis/homebrew-jarvis` tap (e.g. acquires a maintainer's
