# Threat Model — `personal-jarvis/PersonalJarvis` Quick-Install One-Liner
...
>
> Last reviewed: 2026-05-26 against the `personal-jarvis/PersonalJarvis` repo
...
`personal-jarvis/PersonalJarvis`). That is **one trust axis.** If an
