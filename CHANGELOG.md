...
- **In-app / scripted uninstall.** A clean uninstall path (`jarvis/setup/uninstall.py`
  plus `install/uninstall.sh` and `install/uninstall.ps1`) removes Personal Jarvis
  and its local data cross-platform.
