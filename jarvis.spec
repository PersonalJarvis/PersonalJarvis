...
# Icon per platform. Only jarvis.ico ships in the repo; the macOS .icns is
# generated from assets/icons/jarvis-gigi-256.png by the CI build step (and is
# tolerated as missing here — PyInstaller simply omits the icon then).
...
if IS_WIN:
    ...
    _icon_path = _ICON_DIR / "jarvis-gigi-256.png"
